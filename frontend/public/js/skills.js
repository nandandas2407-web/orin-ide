  ...
  PREBUILT: [
    {
      ...
      name: 'Frontend',
      slug: 'frontend',
      icon: '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="16" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="8" y1="9" x2="8" y2="20"/></svg>',
...
15. Deliver COMPLETE, production-ready code — no placeholders or TODOs`
    },
    {
      ...
      name: 'Cinematic',
      slug: 'cinematic',
      icon: '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="3"/><line x1="12" y1="3" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="21"/></svg>',
...
15. Deliver COMPLETE self-contained HTML files with all Three.js loaded from CDN`
    },
    {
      ...
      name: 'Backend',
      slug: 'backend',
      icon: '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="7" rx="1.5"/><rect x="2" y="14" width="20" height="7" rx="1.5"/><line x1="6" y1="6.5" x2="6.01" y2="6.5"/><line x1="6" y1="17.5" x2="6.01" y2="17.5"/></svg>',
...
15. Deliver COMPLETE working server code with package.json and setup instructions`
    },
    {
      ...
      name: 'Game Dev',
      slug: 'gamedev',
      icon: '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="11" rx="4"/><line x1="7" y1="10.5" x2="7" y2="14.5"/><line x1="5" y1="12.5" x2="9" y2="12.5"/><circle cx="16" cy="11.5" r="1"/><circle cx="18.5" cy="14" r="1"/></svg>',
...
15. Deliver COMPLETE playable game in a single HTML file with all assets inline or CDN`
  ...
  createCustom(name, instructions) {
    ...
    this.customSkills.push({
      ...
      name,
      slug,
      icon: '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',
      ...
      skills.forEach(skill => {
        ...
        card.innerHTML = `
          <div class="sk-card-top">
            <span class="sk-icon">${skill.icon || '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>'}</span>
            <div class="sk-meta">
  ...
  _showDropdown(skills, input, cursor) {
    ...
    skills.forEach((skill, i) => {
      ...
      item.innerHTML = `<span class="sk-mention-icon">${skill.icon || '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>'}</span>
...
window.SkillsMgr = SkillsMgr;

// Patch: update the skill chip in chat header
;(function(){
  ...
  SkillsMgr._updateActiveIndicator = function() {
    ...
    const chipLabel = document.getElementById('skill-chip-label');
    const skill = this.getActiveSkill();
    if (chip && chipLabel) {
      if (skill) {
        chipLabel.textContent = skill.name + ' skill active';
